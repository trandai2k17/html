          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var X = this.drawPath({ d: i, stroke: n, strokeWidth: l, fill: c, fillOpacity: 1, classes: f, strokeLinecap: h, strokeDashArray: I });
                    ...
                    return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal
                      ? (function (t) {
                          var e = M(t),
                            ...
                            r = e.startVal,
                            o = e.endVal;
                          return I({ color: i, seriesName: a, ylabel: s, start: r, end: o });
                        })(t)
                      : (function (t) {
                          var e = M(t),
                            i = e.color,
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              (this.chartType = a.chart.type),
                'histogram' === this.chartType && ((a.chart.type = 'bar'), (a = x.extend({ plotOptions: { bar: { columnWidth: '99.99%' } } }, a))),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var o,
                ...
                c = r.gradient.type,
                d = e,
                g = void 0 === r.gradient.opacityFrom ? i : Array.isArray(r.gradient.opacityFrom) ? r.gradient.opacityFrom[s] : r.gradient.opacityFrom;
              d.indexOf('rgba') > -1 && (g = x.getOpacityFromRGBA(d));
              var u = void 0 === r.gradient.opacityTo ? i : Array.isArray(r.gradient.opacityTo) ? r.gradient.opacityTo[s] : r.gradient.opacityTo;
              if (void 0 === r.gradient.gradientToColors || 0 === r.gradient.gradientToColors.length)
                o =
                  'dark' === r.gradient.shade
                    ? h.shadeColor(-1 * parseFloat(r.gradient.shadeIntensity), e.indexOf('rgb') > -1 ? x.rgb2hex(e) : e)
                    : h.shadeColor(parseFloat(r.gradient.shadeIntensity), e.indexOf('rgb') > -1 ? x.rgb2hex(e) : e);
              else if (r.gradient.gradientToColors[n.seriesNumber]) {
                var f = r.gradient.gradientToColors[n.seriesNumber];
                (o = f), f.indexOf('rgba') > -1 && (u = x.getOpacityFromRGBA(f));
              } else o = e;
              ...
              return d.indexOf('rgb') > -1 && (d = x.rgb2hex(d)), o.indexOf('rgb') > -1 && (o = x.rgb2hex(o)), l.drawGradient(c, d, o, g, u, n.size, r.gradient.stops, r.gradient.colorStops, s);
            },
          },
        ]),
        t
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, o) {
              ...
              if (
                ('circle' === f.shape
                  ? (p = u.drawCircle(i))
                  : ('square' !== f.shape && 'rect' !== f.shape) || (p = u.drawRect(0, 0, f.width - f.pointStrokeWidth / 2, f.height - f.pointStrokeWidth / 2, f.pRadius)),
              ...
              if (i.config.series.length > 1)
                for (
                  var s = i.config.series.map(function (t, a) {
                      return t.data && t.data.length > 0 && (!i.globals.comboCharts || 0 === e.length || (e.length && e.indexOf(i.config.series[a].type) > -1)) ? a : -1;
                    }),
                ...
                if (
                  (('rangeBar' !== a.chart.type && 'rangeArea' !== a.chart.type && 'rangeBar' !== t[l].type && 'rangeArea' !== t[l].type) ||
                    ...
                    s.isComboCharts
                      ...
                      : ('rangeBar' !== a.chart.type && 'rangeArea' !== a.chart.type) || this.handleRangeData(t, l)),
                  this.isMultiFormat())
                )
        ...
        r(t, [
          {
            ...
            value: function (t, e, i, a) {
              var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                ...
                f = l;
              o &&
                ((h = u.xLabelFormat(c, l, f, { i: a, dateFormatter: new T(this.ctx).formatDate, w: n })), void 0 !== d && (h = d(l, t[a], { i: a, dateFormatter: new T(this.ctx).formatDate, w: n })));
              var p = function (t) {
                var i = null;
                return (
              ...
              return (
                !Array.isArray(h) && (0 === h.indexOf('NaN') || 0 === h.toLowerCase().indexOf('invalid') || h.toLowerCase().indexOf('infinity') >= 0 || (s.indexOf(h) >= 0 && v)) && (h = ''),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (!((0 === e && l.globals.skipFirstTimelinelabel) || (e === o - 1 && l.globals.skipLastTimelinelabel && !l.config.xaxis.labels.formatter) || 'radar' === l.config.chart.type)) {
                ...
                new G(this.ctx).drawXaxisTicks(i, h, this.elg);
              }
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (s.config.grid.yaxis.lines.show) {
                ...
                for (var g = 0; g < d + (this.isRangeBar ? 1 : 0); g++)
                  this._drawGridLine({ x1: 0, y1: l, x2: c, y2: h, parent: this.elgridLinesH }), (h = l += s.globals.gridHeight / (this.isRangeBar ? d : a));
              }
            },
          },
          {
              ...
              if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                for (var a, s = i.globals.padHorizontal, r = i.globals.gridHeight, o = 0; o < e + 1; o++) {
                  i.config.grid.xaxis.lines.show && this._drawGridLine({ x1: s, y1: 0, x2: a, y2: r, parent: this.elgridLinesV }),
                    new G(this.ctx).drawXaxisTicks(s, 0, this.elg),
                ...
                (C.background = s[l]),
                  ...
                  e.config.legend.markers.customHTML &&
                    (Array.isArray(e.config.legend.markers.customHTML)
                      ? e.config.legend.markers.customHTML[l] && (f.innerHTML = e.config.legend.markers.customHTML[l]())
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              if (f.config.dataLabels.enabled) {
                var X = this.barCtx.series[r][o];
                I = p.getTextRects(f.globals.yLabelFormatters[0](X), parseFloat(C.style.fontSize));
              }
              var z = {
                x: e,
                y: i,
              ...
              return (
                (S = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(z) : this.calculateColumnsDataLabelsPosition(z)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                d.config.chart.stacked && (this.barCtx.yArrj.push(f.y2WithRadius), this.barCtx.yArrjF.push(Math.abs(s - f.y2WithRadius)), this.barCtx.yArrjVal.push(this.barCtx.series[h][c])),
                { pathTo: b, pathFrom: v }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              var x = e,
                ...
                v = d.line(a, b - r);
              return (
                (f = f + d.line(u.x2, x) + u.pathWithRadius + d.line(u.x2, b - r) + v + v + 'z'),
                (p = p + d.line(a, x) + v + v + v + v + v + d.line(a, x)),
                c.config.chart.stacked && (this.barCtx.xArrj.push(u.x2WithRadius), this.barCtx.xArrjF.push(Math.abs(a - u.x2WithRadius)), this.barCtx.xArrjVal.push(this.barCtx.series[l][h])),
                { pathTo: f, pathFrom: p }
              );
            },
          },
        ...
        r(t, [
          {
            ...
            value: function (t, i) {
              ...
              for (var n = 0, l = 0; n < t.length; n++, l++) {
                ...
                for (
                  var C = s.group({ class: 'apexcharts-datalabels', 'data:realIndex': v }), L = s.group({ class: 'apexcharts-bar-goals-markers', style: 'pointer-events: none' }), P = 0;
                  ...
                  var X = this.barHelpers.drawGoalLine({ barXPosition: M.barXPosition, barYPosition: M.barYPosition, goalX: M.goalX, goalY: M.goalY, barHeight: k, barWidth: A });
                  X && L.add(X), (f = M.y), (u = M.x), P > 0 && b.push(u + A / 2), p.push(f);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              T.count > 0 &&
                ...
                (P.node.setAttribute('stroke-dasharray', T.dashArray), P.node.setAttribute('stroke-width', T.strokeWidth), P.node.setAttribute('fill-opacity', T.fillOpacity)),
      ...
      return (
        r(s, [
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e, i = t.indexes, a = t.barHeight, s = t.strokeWidth, r = t.zeroW, o = t.x, n = t.y, l = t.yDivision, h = t.elSeries, c = this.w, d = n, g = i.i, u = i.j, f = 0, p = 0;
              ...
              return (
                ...
                (n += l),
                { pathTo: b.pathTo, pathFrom: b.pathFrom, goalX: this.barHelpers.getGoalValues('x', r, null, g, u), barYPosition: d, x: o, y: n }
              );
            },
          },
          {
        ...
        r(s, [
          {
            ...
            value: function (t, i) {
              ...
              for (var r = s.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }), o = 0; o < t.length; o++) {
                ...
                for (
                  var y = s.group({ class: 'apexcharts-datalabels', 'data:realIndex': u }), w = s.group({ class: 'apexcharts-rangebar-goals-markers', style: 'pointer-events: none' }), k = 0;
                  ...
                  if (((g = v.yDivision), (p = v.barHeight), this.isHorizontal)) {
                    ...
                    if (a.config.series[o].data[k].x) {
                      var X = this.detectOverlappingBars({ i: o, j: k, barYPosition: P, srty: I, barHeight: p, yDivision: g, initPositions: v });
                      (p = X.barHeight), (P = X.barYPosition);
                    }
                  ...
                  var z = this.barHelpers.drawGoalLine({ barXPosition: L.barXPosition, barYPosition: P, goalX: L.goalX, goalY: L.goalY, barHeight: p, barWidth: b });
            ...
            value: function (t) {
              ...
              for (var I = n, X = 0; X < a; X++) {
                ...
                z
                  ...
                  : ((n = f - i[r][X + 1] / A[this.yaxisIndex] + 2 * (this.isReversed ? i[r][X + 1] / A[this.yaxisIndex] : 0)),
                    'rangeArea' === e && (I = f - y[r][X + 1] / A[this.yaxisIndex] + 2 * (this.isReversed ? y[r][X + 1] / A[this.yaxisIndex] : 0))),
                  p.push(o),
                  b.push(n);
              ...
              if ((Array.isArray(b.config.stroke.curve) && (y = Array.isArray(p) ? b.config.stroke.curve[p[a]] : b.config.stroke.curve[a]), 'smooth' === y)) {
                ...
                b.globals.hasNullValues
                  ...
                  r === i[a].length - 2 &&
                    ...
                    'rangeArea' === e && x ? (d = d + v.curve(h, c, o, n, o, l) + v.move(o, l) + 'z') : b.globals.hasNullValues || (u.push(d), f.push(g)));
              } else {
                if (null === i[a][r + 1]) {
                  d += v.move(o, n);
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                d >= 60 && ((d = 0), 24 === (p += 1) && (p = 0)),
                  this.timeScaleArray.push({ position: b, value: d, unit: 'minute', hour: p, minute: d, day: g, year: this._getYear(f, u, 0), month: x.monthMod(u) }),
                  (b += l),
                  d++;
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              return new Promise(function (s, r) {
                ...
                (null === e || a.globals.allSeriesCollapsed) && i.series.handleNoData(), 'treemap' !== a.config.chart.type && i.axes.drawAxis(a.config.chart.type, e.xyRatios), (i.grid = new j(i));
